...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_questions(self):
        #  was_publshed_recently() returns False for questions whose pub_date is older than 1 day
...
def create_question(question_text, days):
    ...
    # , postive for questions that have yet to be published).
...
class QuestionDetailViewTests(TestCase):
    def test_future_questions(self):
        #  the detial view of a question with a pub_date in the future returns a 404 not found
